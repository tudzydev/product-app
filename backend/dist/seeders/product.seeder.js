...
exports.seedDatabase = exports.sampleProducts = void 0;
...
const seedDatabase = async (force = false) => {
    if (force) {
        await models_1.Product.destroy({ where: {}, truncate: true });
        const created = await models_1.Product.bulkCreate(exports.sampleProducts);
        return { count: created.length, message: `Successfully reset and seeded ${created.length} products.` };
    }
    const existingCount = await models_1.Product.count();
    if (existingCount > 0) {
